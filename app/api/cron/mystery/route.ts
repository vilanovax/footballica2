...
/**
 * Pre-schedules Mysterious Player puzzles for the Tehran week ahead.
...
export async function GET(request: Request) {
  ...
  const daysParsed = daysRaw ? Number(daysRaw) : MYSTERY_SCHEDULE_DAYS;
  ...
  try {
    ...
    console.error("cron/mystery failed", err);
