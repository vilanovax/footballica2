...
export function HubTodayRail({
  ...
  return (
    <section className="flex flex-col gap-2">
      ...
      {/* Compact dual rail — same club chrome, no rainbow cards */}
      <div className="grid grid-cols-2 gap-2">
        <motion.div whileTap={{ scale: 0.98 }}>
          <Link
            ...
            className={[
              "relative flex min-h-12 w-full items-center gap-2 overflow-hidden rounded-2xl border-2 px-2.5 py-2 shadow-[0_3px_0_0_rgba(0,0,0,0.28)]",
              hotMystery
                ? "border-amber-400/45 bg-linear-to-br from-[#1a2e1a] via-[#14532d] to-[#0f172a]"
                : "border-white/15 bg-linear-to-br from-[#0f172a] via-[#14532d]/80 to-[#052e16]",
            ].join(" ")}
          >
            ...
            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-accent text-accent-foreground shadow-[0_2px_0_0_rgba(0,0,0,0.35)]">
        ...
        {seasonOn && campaignSeason ? (
          <motion.button
            ...
            className={[
              "relative flex min-h-12 w-full items-center gap-2 overflow-hidden rounded-2xl border-2 px-2.5 py-2 text-start shadow-[0_3px_0_0_rgba(0,0,0,0.28)]",
              rewardReady
                ? "border-amber-400/50 bg-linear-to-br from-[#1a2e1a] via-[#3f6212] to-[#0f172a]"
                : "border-white/15 bg-linear-to-br from-[#0f172a] via-[#14532d]/80 to-[#052e16]",
            ].join(" ")}
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            {hasCampaignBody ? (
              ...
              <Play
                className="ms-0.5 h-3.5 w-3.5 shrink-0 fill-current text-accent"
                aria-hidden
              />
            )}
          </motion.button>
          ...
          <button
            ...
            className="relative flex min-h-12 w-full items-center gap-2 overflow-hidden rounded-2xl border-2 border-white/15 bg-linear-to-br from-[#0f172a] via-[#14532d]/80 to-[#052e16] px-2.5 py-2 text-start shadow-[0_3px_0_0_rgba(0,0,0,0.28)]"
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              ...
              className="h-8 w-8 shrink-0 object-contain"
            />
            <span className="min-w-0 flex-1 truncate font-display text-xs font-black text-white">
              {t("missions.tabPath")}
            </span>
          </button>
        )}
